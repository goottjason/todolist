...
<div class="container mt-5" style="max-width:540px; margin:48px auto; background:#fff; border-radius:14px; box-shadow:0 2px 16px rgba(40,60,90,0.08); padding:36px 32px 28px 32px;">
  <div class="row" style="margin:0;">
    <h1 style="font-size:1.7rem; font-weight:700; color:#2453e3; margin-bottom:32px; text-align:center; letter-spacing:-1px;">
    ...
    <div class="container mt-3" style="padding:0;">
      <form action="updateinfo" method="POST">
        <table class="table table-hover" style="width:100%; border-collapse:separate; border-spacing:0 14px;">
          <tr>
            <td style="width:30%; font-weight:600; color:#2453e3; background:#f6f8fb; border-radius:8px 0 0 8px; padding:12px 14px;">아이디</td>
            <td style="background:#f7f7fa; border-radius:0 8px 8px 0; padding:12px 14px;">${authUser.userid}</td>
          </tr>
          <tr>
            <td style="font-weight:600; color:#2453e3; background:#f6f8fb; border-radius:8px 0 0 8px; padding:12px 14px;">비밀번호</td>
            <td style="background:#f7f7fa; border-radius:0 8px 8px 0; padding:12px 14px;">
              <input type="button" value="비밀번호 변경" onclick="pwdmodBtnClick()" style="background:#2453e3; color:#fff; border:none; border-radius:6px; padding:7px 16px; font-size:14px; font-weight:600; cursor:pointer;">
              <div id="pwdmod" style="margin-top:12px;">
                ...
                <input type="button" value="확인" onclick="existingpwdBtnClick();" style="background:#2453e3; color:#fff; border:none; border-radius:6px; padding:7px 16px; font-size:14px; margin-left:6px; font-weight:600; cursor:pointer;">
          ...
          <tr>
            <td style="font-weight:600; color:#2453e3; background:#f6f8fb; border-radius:8px 0 0 8px; padding:12px 14px;">이메일</td>
            <td style="background:#f7f7fa; border-radius:0 8px 8px 0; padding:12px 14px;">${authUser.useremail}</td>
          </tr>
          <tr>
            <td style="font-weight:600; color:#2453e3; background:#f6f8fb; border-radius:8px 0 0 8px; padding:12px 14px;">이름</td>
            <td style="background:#f7f7fa; border-radius:0 8px 8px 0; padding:12px 14px;">
          ...
          <tr>
            <td style="font-weight:600; color:#2453e3; background:#f6f8fb; border-radius:8px 0 0 8px; padding:12px 14px;">주소</td>
            <td style="background:#f7f7fa; border-radius:0 8px 8px 0; padding:12px 14px;">
        ...
        <div style="display:flex; gap:10px; margin-top:28px;">
          <button type="submit" class="btn btn-success" onclick="return mainpageIsValid();"
            style="flex:1; background:#2453e3; color:#fff; border:none; border-radius:7px; padding:12px 0; font-size:15px; font-weight:600; cursor:pointer;">저장</button>
          <button type="submit" class="btn btn-danger"
            style="flex:1; background:#e0e4ea; color:#2453e3; border:none; border-radius:7px; padding:12px 0; font-size:15px; font-weight:600; cursor:pointer;">취소</button>
        </div>
      </form>
    </div>
  </div>
